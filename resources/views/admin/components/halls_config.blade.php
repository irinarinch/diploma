    ...
    <div class="conf-step__wrapper">    
        ...
        <ul class="conf-step__selectors-box">
            @foreach ($halls as $hall)             
                <li>
                    <input form="edit_form" type="radio" class="conf-step__radio" name="chairs" value={{$hall}} >
                    <span class="conf-step__selector">Зал {{$hall->id}}</span>
                </li>
            @endforeach         
        </ul>       

        <p class="conf-step__paragraph">Укажите количество рядов и максимальное количество кресел в ряду:</p>                          
        <form class="conf-step__legend" method="POST" id="edit_form">
            @method('PATCH')
            @csrf

            <label class="conf-step__label">Рядов, шт<input type="text" class="conf-step__input" placeholder="10" name="row"></label>
            <span class="multiplier">x</span>
            <label class="conf-step__label">Мест, шт<input type="text" class="conf-step__input" placeholder="8" name="place" ></label>
        </form>
        ...
        <fieldset class="conf-step__buttons text-center">
            ...
            <input form="edit_form" type="submit" value="Сохранить" class="conf-step__button conf-step__button-accent">
        </fieldset>                 
    </div>
</section>