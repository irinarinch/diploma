...
<head>
  ...
  <link rel="stylesheet" href="files/client/css/normalize.css">
  <link rel="stylesheet" href="files/client/css/styles.css">
...
<body>
  ...
  <main>
    <section class="movie">
      <div class="movie__info">
        <div class="movie__poster">
          <img class="movie__poster-image" alt="Звёздные войны постер" src="files/client/i/poster1.jpg">
        </div>
    ...
    <section class="movie">
      <div class="movie__info">      
        <div class="movie__poster">
          <img class="movie__poster-image" alt="Альфа постер" src="files/client/i/poster2.jpg">
        </div>
        <div class="movie__description">        
    ...
    <section class="movie">
      <div class="movie__info">      
        <div class="movie__poster">
          <img class="movie__poster-image" alt="Хищник постер" src="files/client/i/poster2.jpg">
        </div>
        <div class="movie__description">        
